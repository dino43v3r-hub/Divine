...
- Auto approval scope: routing_and_queue_only_not_claim_confidence
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 1207
- URL: https://doi.org/10.4314/actat.v22i1.5453
...
- Auto approval scope: routing_and_queue_only_not_claim_confidence
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 1929
- URL: https://doi.org/10.26907/2782-4756-2025-79-1-28-36

The article deals with the occasional past passive participles of the type zabluzhennyi, prisnennyi,
derived from the reflexiva tantum verbs. The problem of the derivation and use of these forms raises
a number of questions related to the definition of the criteria for the normativity of these
derivatives, their qualification as an error or as a language game, and an explanation of the
reasons for their use. The material for the corpus-based study is data from “The General Internet-
Corpus of Russian (GICR)”. The purpose of the study is to search for derivational principles of
occasional participles, to evaluate statistics of their use, to consider the contextual conditions
of the use of part
...
- Tags: world_languages_translation
- Layer routes: world_languages, all_texts, theologians, visual_art
- Primary layer: world_languages
- Provider: OpenAlex
- Quality: scholarly metadata
- Media kind: none
...
- URL: http://dx.doi.org/10.46586/mp.281
...
- Auto approval scope: routing_and_queue_only_not_claim_confidence
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 1510
...
- Auto approval scope: routing_and_queue_only_not_claim_confidence
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 2164
...
- Auto approval scope: manual_review_required
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 2165
...
- Auto approval scope: manual_review_required
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 1930
...
- Auto approval scope: routing_and_queue_only_not_claim_confidence
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 2727
...
- Auto approval scope: manual_review_required
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 1823
...
- Auto approval scope: routing_and_queue_only_not_claim_confidence
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 1231
...
- Auto approval scope: manual_review_required
- Confidence effect: none_until_human_review
- Corroborating routed candidates: 2202
