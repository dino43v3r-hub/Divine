...
6. Source-check machine-drafted companions before trusting them.
   The project currently has 113 candidate leads and 451 machine-drafted companion record(s) still requiring source-check. Machine drafts can organize the work, but they should not raise confidence until the source has been directly checked.
   First machine-draft source-check item: `all_texts/global_text_exploration_framework.md`.
